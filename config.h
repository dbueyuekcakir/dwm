...
static const char *fonts[] 		= { "Source Code Pro:pixelsize=16:antialias=true:autohint=true" , "Font Awesome:pixelsize=16:antialias=true:autohint=true" };
...
static const char col_cyan[] 		= "#996600";
...
static Key keys[] = {
	...
	{ ShiftMask, 			XF86XK_MonBrightnessUp, 	spawn,			SHCMD("xbacklight -set 100; kill -37 $(pidof dwmblocks)") },
	{ ShiftMask, 			XF86XK_MonBrightnessDown,	spawn,			SHCMD("xbacklight -set 10; kill -37 $(pidof dwmblocks)") },
};
